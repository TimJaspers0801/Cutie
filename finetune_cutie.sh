...
srun apptainer exec --nv /gpfs/home1/tjaspers2/Cutie/cutie.sif torchrun --master_port 25357 --nnodes 1 --nproc_per_node=4 cutie/train.py exp_id=0001 model=base data=SurgeSAM pre_training.enabled=False weights=/gpfs/home1/tjaspers2/Cutie/weights/cutie-base-mega.pth