...
if __name__ == '__main__':
    ...
    # Validation set
    original_path = r'E:\SurgeSAM_finetuning_ritm\masks'
    new_path = r'E:\SurgeSAM_finetuning_ritm\masks_pickle'
    
    # # Train set
    # original_path = r'G:\datasets\RAMIE_879_RITM_v2\Train\masks'
    # new_path = r'G:\datasets\RAMIE_879_RITM_v2\Train\masks_pickle'
